...
class OptionsControllerTest < ActionController::TestCase
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post :create, option: { film: @option.film, message: @option.message, time: @option.time, twitter: @option.twitter, wish_id: @option.wish_id }
    end
  ...
  test "should update option" do
    patch :update, id: @option, option: { film: @option.film, message: @option.message, time: @option.time, twitter: @option.twitter, wish_id: @option.wish_id }
    assert_redirected_to option_path(assigns(:option))
  end
